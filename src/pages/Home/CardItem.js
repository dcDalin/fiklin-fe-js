    ...
    <>
      <div className="card-media">
        <div className="card-media-object-container">
          <div
            ...
            style={{
              backgroundImage: `url(http://milimanibackpackers.com/wp-content/uploads/2013/11/hellsgate-1.jpg)`,
            }}
          />
          <span className="card-media-object-tag subtle">Selling Fast</span>
          <ul className="card-media-object-social-list">
            <li>
              <img src="https://s10.postimg.cc/3rjjbzcvd/profile_f.jpg" alt="" className="" />
            </li>
            <li>
              <img src="https://s16.postimg.cc/b0j0djh79/profile_0_f.jpg" alt="" className="" />
            </li>
      ...
      <div className="card-media">
        <div className="card-media-object-container">
          <div
            className="card-media-object"
            style={{ backgroundImage: `url(https://s16.postimg.cc/x8m99xtgl/tyco_f.jpg)` }}
          />
          <ul className="card-media-object-social-list">
            <li>
              <img src="https://s13.postimg.cc/c5aoiq1w7/stock3_f.jpg" alt="" className="" />
            </li>
          </ul>
        </div>
        <div className="card-media-body">
